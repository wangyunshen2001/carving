...
import com.example.lineartest.base.BaseInterface;
...
public class MailUtil {
    ...
    public static void sendEmail(String email, String subject, String body) throws IOException {
        String server = BaseInterface.server;
        String user = BaseInterface.user;
        String password = BaseInterface.password;
    ...
    public static void main(String args[]) throws Exception {
        ...
        MailUtil.sendEmail("982339661@qq.com", "ceshi", "ce");
